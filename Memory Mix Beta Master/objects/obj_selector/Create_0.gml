...
ds_map_add(global.cue_sounds, obj_bird, snd_ani_bird);
ds_map_add(global.cue_sounds, obj_cat, snd_ani_cat);
ds_map_add(global.cue_sounds, obj_chicken, snd_ani_chicken);
ds_map_add(global.cue_sounds, obj_cow, snd_ani_cow);
ds_map_add(global.cue_sounds, obj_dog, snd_ani_dog);
ds_map_add(global.cue_sounds, obj_elephant, snd_ani_elephant);
ds_map_add(global.cue_sounds, obj_horse, snd_ani_horse);
ds_map_add(global.cue_sounds, obj_lion, snd_ani_lion);
ds_map_add(global.cue_sounds, obj_pig, snd_ani_pig);
ds_map_add(global.cue_sounds, obj_rooster, snd_ani_rooster);
ds_map_add(global.cue_sounds, obj_sheep, snd_ani_sheep);
ds_map_add(global.cue_sounds, obj_snake, snd_ani_snake);
...
ds_list_add(global.unused_actions, Pressdown);
ds_list_add(global.unused_actions, Pressup);
ds_list_add(global.unused_actions, Pressleft);
ds_list_add(global.unused_actions, Pressright);
ds_list_add(global.unused_actions, Pressspace);
ds_list_add(global.unused_actions, Swipedown);
ds_list_add(global.unused_actions, Swipeup);
ds_list_add(global.unused_actions, Swiperight);
ds_list_add(global.unused_actions, Swipeleft);
