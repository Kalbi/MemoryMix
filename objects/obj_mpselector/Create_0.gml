...
if (global.easy) { // starts an easy game
	instance_create_depth(250, 600, 0, obj_multi_easy);
}
...
// maps the p1 keys to the p2 keys	
	global.p1mapping = ds_map_create();
		...
		ds_map_add(global.p1mapping, global.swiperightid, global.stickleftid);
		ds_map_add(global.p1mapping, global.swipeleftid, global.stickrightid);
