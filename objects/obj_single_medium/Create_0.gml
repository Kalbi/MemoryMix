// Medium mode has 5 healths for the player, introduces 2 new cues per round after
// round 1 and doesn't reminds the player what the action is for a cue when they get it incorrect

global.roundnum = 1; // Which round the player is currently in

global.thescore = 0; // The player's score

global.maxhealths = 5; // The player's staring health
