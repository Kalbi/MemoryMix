...
ds_map_add(global.cues_mapping, sprt_electricguitar, snd_electricguitar);
...
ds_map_add(global.cues_mapping, sprt_ukelele, snd_intro_ukelele);
ds_map_add(global.cues_mapping, sprt_harmonica, snd_intro_harmonica);
ds_map_add(global.cues_mapping, sprt_panflute, snd_intro_panflute);
ds_map_add(global.cues_mapping, sprt_recorder, snd_intro_recorder);
ds_map_add(global.cues_mapping, sprt_xylophone, snd_intro_xylophone);
// City sound pack
...
ds_map_add(global.cues_mapping, sprt_runner, snd_intro_runners);
ds_map_add(global.cues_mapping, sprt_canoe, snd_intro_canoe);
ds_map_add(global.cues_mapping, sprt_idletruck, snd_intro_idletruck);
ds_map_add(global.cues_mapping, sprt_helicopter, snd_intro_helicopter);
ds_map_add(global.cues_mapping, sprt_airplane, snd_intro_plane);
ds_map_add(global.cues_mapping, sprt_rocket, snd_intro_rocket);
ds_map_add(global.cues_mapping, sprt_bus, snd_intro_schoolbus);
ds_map_add(global.cues_mapping, sprt_boat, snd_intro_boat);
ds_map_add(global.cues_mapping, sprt_ufo, snd_intro_ufo);
ds_map_add(global.cues_mapping, sprt_skateboard, snd_intro_skateboard);
ds_map_add(global.cues_mapping, sprt_choochoo, snd_intro_choochoo);
...
ds_map_add(global.cue_sounds, sprt_electricguitar, snd_eectrig);
